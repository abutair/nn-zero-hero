...
class DataLoaderLite:
    def __init__(self, B, T, process_rank, num_processes, split):
        ...
        assert os.path.exists(self.file_path), f"File not found: {self.file_path}"

        self.reset()

    def reset(self):
        # Load all tokens from the file
        self.tokens = self.load_tokens(self.file_path)
    ...
    def load_tokens(self, file_path):
        ...
        with open(file_path, 'r') as f:
            text = f.read()
        # Convert text to tokens (this is a simplified example)
